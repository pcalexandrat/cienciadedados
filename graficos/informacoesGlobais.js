...
async function vizualizarInformacoesGlobais() {
    ...
    paragrafo.innerHTML = `Você sabia que  do total de <span> ${pessoas_mundo} </span> de pessoas no mundo,  
            ...
            é de menos de <span> ${horas}horas </span> e <span> ${minutos} minutos </span>`
